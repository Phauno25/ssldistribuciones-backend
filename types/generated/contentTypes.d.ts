...
export interface ApiFormSubmissionsContactoFormSubmissionsContacto
  extends Schema.CollectionType {
  collectionName: 'form_submissions_contactos';
  info: {
    singularName: 'form-submissions-contacto';
    pluralName: 'form-submissions-contactos';
    displayName: 'Form Submissions: Contacto';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::form-submissions-contacto.form-submissions-contacto',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    hero: Attribute.Component<'layout.hero-center-with-bg-image'>;
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    menuItem: Attribute.DynamicZone<['ui.link', 'ui.link-list']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    hero: Attribute.Component<'layout.hero-center-with-bg-image', true>;
    body: Attribute.DynamicZone<
      [
        'layout.section',
        'layout.section-with-cta',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    codigoFabricante: Attribute.String & Attribute.Private;
    ...
    details: Attribute.Component<'data.key-value', true>;
...
export interface ApiProductCollectionProductCollection
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::product-collection.product-collection', 'name'>;
    subcategory: Attribute.Relation<
      'api::product-collection.product-collection',
      'manyToOne',
      'api::product-subcategory.product-subcategory'
...
export interface ApiProductDetailProductDetail extends Schema.CollectionType {
  ...
  attributes: {
    detail: Attribute.Component<'data.key-value', true>;
    name: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductSubcategoryProductSubcategory
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::product-subcategory.product-subcategory', 'name'>;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slub: Attribute.UID<'api::service.service', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
